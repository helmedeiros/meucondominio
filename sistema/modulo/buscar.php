...
//verifica se o su possue permissão para visualizar(4) no modulo(5)
if(!permissoesDAO::temPermissao(5,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = modulosDAO::countByBusca($nome, $descricao);
	

    $modulos = modulosDAO::findTopByBusca($nome, $descricao,$nxt,$total_mural);
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$tiposervicos[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Módulo </td>
                        <td width="51%" class="tabela1_titulo2">Descricao</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="nome" class="FORMULARIO" id="nome" type="text" size="20" value="<?php=$nome?>" />
                        </td>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="descricao" class="FORMULARIO" id="descricao" type="text" size="20" value="<?php=$descricao?>" />
                        </td>
