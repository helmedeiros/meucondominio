...
$receitas = ReceitaDespesaDAO::findTopByBusca("", $mes, $ano, $id_condominio, 'despesa');
         ...
         <br />
			...
			?>
                    <tr>
					  ...
					  <form action="excluir.php" method="post" onsubmit="javascript:return confirma('<?php=$receitas[$i]->nome?>','despesa')">
