...
$total = ReceitaDespesaDAO::somaTotal('despesa', $mes, $ano, $id_condominio);
		    ...
		    <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
              <tr>
                <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="89%" class="tabela1_titulo1">Gráficos das Despesas do mês (<?php=$mes?>/<?php=$ano?>)</td>
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      <td height="31" colspan="2" nowrap="nowrap" class="tabela1_linha2">
					  	<span class="warning">*Para acessar os gráficos clique sobre suas imagens.</span>						
					  </td>
                    </tr>  
