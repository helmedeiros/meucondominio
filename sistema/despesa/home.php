        ...
        <tr>
         ...
         <br />
            ...
            <br />
			 ...
			 <form onsubmit="return checa_formulario(this)" action="home.php" method="post">
                ...
                <tr>
				  ...
				  <?php 
                    ...
                    <tr>
                      ...
                      <td width="12%" class="tabela1_titulo2">Pago</td>
                      <td width="23%" class="tabela1_titulo2">Valor Cobrado  </td>
                      <td width="23%" class="tabela1_titulo2">Valor Pago </td>
