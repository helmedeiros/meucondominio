...
$receitas = ReceitaDespesaDAO::findTopByBusca("", $mes, $ano, $id_condominio, 'despesa',"",2);
      ...
      <table width="545" border="0" cellspacing="0" cellpadding="0">
        <tr>
         ...
         <br />
            ...
            <table cellpadding="0" cellspacing="0" width="99%" class="tabela1">
			   <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Despesas do mês (<?php=$mes?>/<?php=$ano?>)</td>
                ...
                <tr>
				  ...
				  <?php 
                    ...
                    <tr>
                      <td class="tabela1_titulo2">Centro de Custo </td>
                      <td class="tabela1_titulo2">Documento</td>
                      <td class="tabela1_titulo2">Data de Emiss&atilde;o</td>
                      <td class="tabela1_titulo2">Data de Vencimento </td>
                      <td class="tabela1_titulo2">Pago</td>
                      <td class="tabela1_titulo2">Valor Cobrado </td>
                      <td class="tabela1_titulo2">Valor Pago </td>
			...
			?>
                    <tr>
                      <td class="<?php=$classe?>"><a href="#" onmouseover="doTooltip(event, 0, '<?php=$receitas[$i]->centro->nome?>')" onmouseout="hideTip()"><?php=substr($receitas[$i]->centro->nome,0,5)?></a></td>
                      <td class="<?php=$classe?>"><a href="#" onmouseover="doTooltip(event, 0, '<?php=$receitas[$i]->documento?>')" onmouseout="hideTip()"><?php=substr($receitas[$i]->documento,0,6)?>...</a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#" onmouseover="doTooltip(event, 0, '<?php=$receitas[$i]->data_emissao[8].$receitas[$i]->data_emissao[9]."/".$receitas[$i]->data_emissao[5].$receitas[$i]->data_emissao[6]."/".$receitas[$i]->data_emissao[2].$receitas[$i]->data_emissao[3]?>')" onmouseout="hideTip()"><?php=$receitas[$i]->data_emissao[8].$receitas[$i]->data_emissao[9]."/".$receitas[$i]->data_emissao[5].$receitas[$i]->data_emissao[6]?></a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#"><?php=$receitas[$i]->data_vencimento[8].$receitas[$i]->data_vencimento[9]."/".$receitas[$i]->data_vencimento[5].$receitas[$i]->data_vencimento[6]."/".$receitas[$i]->data_emissao[2].$receitas[$i]->data_emissao[3]?></a></td>
                      ...
                      <?php  }else{?>
					  		Sim
                        <?php  }?>                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#"><?php=number_format(stripslashes($receitas[$i]->valor), 2, ',', '.')?></a></td>					  
                      <td class="<?php=$classe2?>" nowrap="nowrap"><a href="<?php  if($classe == 'tabela1_linhaGreen'){?>home.php?mes=<?php=$receitas[$i]->data_pagamento_recebimento[5].$receitas[$i]->data_pagamento_recebimento[6]?>&ano=<?php=$receitas[$i]->data_pagamento_recebimento[0].$receitas[$i]->data_pagamento_recebimento[1].$receitas[$i]->data_pagamento_recebimento[2].$receitas[$i]->data_pagamento_recebimento[3]?>"  onmouseover="doTooltip(event, 0, 'Recebido em:<?php=$receitas[$i]->data_pagamento_recebimento[8].$receitas[$i]->data_pagamento_recebimento[9]?>-<?php=$receitas[$i]->data_pagamento_recebimento[5].$receitas[$i]->data_pagamento_recebimento[6]?>-<?php=$receitas[$i]->data_pagamento_recebimento[0].$receitas[$i]->data_pagamento_recebimento[1].$receitas[$i]->data_pagamento_recebimento[2].$receitas[$i]->data_pagamento_recebimento[3]?>')" onmouseout="hideTip()"<?php  }else{?>#"<?php  }?>><?php=number_format(stripslashes($receitas[$i]->valor_pago), 2, ',', '.')?></a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="adicionar.php?id=<?php=$receitas[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
					<?php  if($receitas[($i+1)]->area->nome != $areaAtual){ ?>
                    <tr>
                      <td colspan="6" nowrap="nowrap" class="tabela1_linha2"><a href="#"><div align="right">TOTAL------------&gt;</div></a></td>
                      <td colspan="3" nowrap="nowrap" class="tabela1_linha2"><?php=number_format(ReceitaDespesaDAO::somaValoresByArea('despesa', $mes, $ano, $areaAtual, $condominio->id), 2, ',', '.')?></td>
                    </tr>
            <?php 
						}
				}
			?>
				...
				<tr>
				  <td class="tabela1_linhaGreen">*A despesa foi emitida no mês atual, porém só foi paga em outro mês(data relatada posicionando o mouse sobre o valor recebido).</td>
			  </tr>
				<tr>
				  <td class="tabela1_linhaAzul">*A despesa foi emitida em outro mês, porém só foi paga no mês atual.</td>
			  </tr>
				<tr>
...
<div align="center"><span class="verdanaAzul">
			 	Não existem despesas do condomínio cadastrados
			</span></div>
			 <?php 	
				}
				}
