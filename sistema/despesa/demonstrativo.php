...
<table width="545" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td><div align="center"><strong>DEMONSTRATIVO DE DESPESAS </strong></div></td>
  </tr>
</table>
</p>
...
<table width="545" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#000000">
  <tr>
    <td width="396" bgcolor="#FFFFFF"><div align="center"><strong>DESPESAS</strong></div></td>
          ...
          <tr>
                ...
                <?php 
					...
					for ($i = 0; $i < sizeof($receitas); $i++){
						if($receitas[$i]->area->nome != $areaAtual){
							...
							$totalArea = number_format(ReceitaDespesaDAO::somaValoresByArea('despesa', $mes, $ano, $areaAtual, $condominio->id), 2, ',', '.');
							if($totalArea != "0,00"){
					?>
                <tr>
			...
			<?php 	
				...
				if($receitas[($i+1)]->centro->nome != $centroAtual){
					$totalCentro = number_format(ReceitaDespesaDAO::somaValoresByCentro('despesa', $mes, $ano, $receitas[$i]->area->nome, $centroAtual, $id_condominio), 2, ',', '.');					if($totalCentro != "0,00"){
			?>
                <tr>
