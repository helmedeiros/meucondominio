...
//verifica se o su possue permissão para visualizar(4) no modulo(28)
if(!permissoesDAO::temPermissao(28,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = tiposservicosDAO::countByBusca($nome, $descricao);
	

    $tiposervicos = tiposservicosDAO::findTopByBusca($nome, $descricao,$nxt,$total_mural);
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="29%" class="tabela1_titulo2">Tipo de Serviço </td>
                      <td width="64%" class="tabela1_titulo2">Descrição</td>
                      <td width="7%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($tiposervicos); $i++){
                    ...
                    <tr>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$tiposervicos[$i]->nome?>
                      </a></td>
                      <td nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                        <?php=substr($tiposervicos[$i]->descricao, 0, 50)?>
                        <?php  if(strlen($tiposervicos[$i]->descricao) >= 50){?>
                        ...
                        <?php  }?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="adicionar.php?id=<?php=$tiposervicos[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Tipo de Serviço </td>
