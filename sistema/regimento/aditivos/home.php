        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="images/topo_espaco.jpg"><a href="home.php?reg=<?php=$reg?>"><img src="../../images/botao_listar.jpg" name="listar1" width="78" height="40" border="0" id="listar1" /></a></td>
        ...
        <tr>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <br />
			 ...
			 Regimento -&gt; <strong><a href="../adicionar.php?id=<?php=$reg?>"><?php  echo $regimento->regimento; ?>
			 </a></strong><br />
             <br />
                <br />
                <br />
			...
			<table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="460">
                    <tr>
                      <td width="224" class="tabela1_titulo2">Aditivo</td>
                      <td width="193" class="tabela1_titulo2">Data</td>
                    ...
                    <tr>
                      <td class="tabela1_linha2" nowrap="nowrap" ><a href="#" onmouseover="doTooltip(event, 0, '<?php=$aditivos[$i]->aditivo?>')" onmouseout="hideTip()">
                        <?php=substr($aditivos[$i]->aditivo, 0, 20)?>
                        <?php  if(strlen($aditivos[$i]->aditivo) >= 22){?>
...
<?php  } ?>
                      </a><a href="#"></a></td>
...
<?php=$aditivos[$i]->data_envio[5].$aditivos[$i]->data_envio[6]?>
                     ...
                     <?php  if ($aditivos[$i]->nome_arquivo != "") { ?>
					 <td class="tabela1_linha2">
					  <a href="../arquivos/<?php=$id_condominio?>/aditivos/<?php=$aditivos[$i]->nome_arquivo?>"><img src="../../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr><?php  } else { ?>
					  <td class="tabela1_linha2">
					  <a href="adicionar?adt=<?php=$aditivos[$i]->id?>&amp;reg=<?php=$reg?>"><img src="../../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr> <?php  } ?>
                    <?php 
							 } 
						?>
			...
			<div align="center" class="fontelink"><?php  if(($nxt) > 0) {?>
                    <a href="home.php?nxt=<?php=($nxt - $total)?>&amp;reg=<?php=$reg?>">
                    <?php  } ?>
                    Anterior</a> |
                    <?php  if(($nxt + $total_mural) < $total) {?>
                    <a href="home.php?nxt=<?php=($nxt + $total_mural)?>&amp;reg=<?php=$reg?>">
                    <?php  } ?>
