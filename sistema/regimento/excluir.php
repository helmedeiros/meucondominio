          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="460">
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2"><a href=""><?php  if($regimentos[$i]->status == 1) { ?>
                        Em vigência
                        <?php  } else { ?>
                        Inativo
                        <?php  } ?></a></td>
                      ...
                      <td class="tabela1_linha2"><form action="excluir.php" method="post" onsubmit="javascript:return confirma('<?php=$regimentos[$i]->regimento?>','Regimento')">
                        <input name="image" type="image" src="../images/xis.jpg" width="20" height="21" border="0" />
                        <input type="hidden" value="<?php=$regimentos[$i]->id?>" name="id" />
                      </form>                        </td>
                    </tr>
                    <?php 
							}
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem Regimentos cadastrados
			</span></div>
			 <?php 	
				}
			?>
