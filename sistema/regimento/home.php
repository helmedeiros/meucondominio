...
<?php=$r[$i]->data_envio[5].$regimentos[$i]->data_envio[6]?>
                      ...
                      <td class="tabela1_linha2"><div align="center"><a href="aditivos/home.php?reg=<?php=$regimentos[$i]->id?>"><img src="../images/lupa.jpg" width="20" height="21" border="0" /></a></div></td>
