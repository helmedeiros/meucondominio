...
//}	
	...
	$regimentos = regimentosDAO::findByPk($reg);
	if($_FILES['arquivo']['name'] != ""){
		$arquivo = $_FILES['arquivo'];
		$ftp = new Ftp();
		$ftp->salvaReg($id_condominio, $arquivo, $arquivo_name);
		$regimentos->nome_arquivo = $arquivo_name;	
		}
		
$id = regimentosDAO::save($regimentos, $reg);
header("Location: adicionar.php?id=$reg");
	exit();
