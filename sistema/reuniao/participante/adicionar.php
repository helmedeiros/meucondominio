...
header("Location: home.php?ata=$id");
exit();	
        ...
        <td><!-- menu superior -->
              <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td valign="top" background="images/topo_espaco.jpg"><a href="home.php?ata=<?php=$id?>"><img src="../../images/botao_listar_off.jpg" name="listar1" width="78" height="40" border="0" id="listar1" /></a></td>
                  ...
                  <td valign="top" background="images/topo_espaco.jpg"><a href="excluir.php?ata=<?php=$id?>"><img src="../../images/botao_excluir_off.jpg" name="excluir1" width="87" height="40" border="0" id="excluir1" /></a></td>
                </tr>
            </table></td>
      </tr>
      <tr>
                    ...
                    <tr>
                      <td><table cellpadding="1" cellspacing="1" width="100%">
                          ...
                          <tr>
                            ...
                            <td width="76%" class="tabela1_linha2" ><select name="qtdpart">
