...
if($find == 1){		
	...
	$total = atasreuniaoDAO::countByBusca($assunto, $data, $escriba);
	
	$atasreuniao = atasreuniaoDAO::findTopByBusca($assunto, $data, $escriba, $nxt, $total_mural);
			...
			<table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
              <tr>
                <td width="460" bgcolor="#6598CB"><table width="460" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="407" class="tabela1_titulo1">Top 10  Reuniões (ordem alfabética) <?php  echo sizeof($atasreuniao); echo sizeof($total);  ?> </td>
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="460">
                    <tr>
                      <td width="84" class="tabela1_titulo2">Data</td>
                      <td width="43" class="tabela1_titulo2" nowrap="nowrap">Início</td>
                      <td width="41" class="tabela1_titulo2" nowrap="nowrap">Fim</td>
                      <td width="83" class="tabela1_titulo2">Assunto</td>
                      <td width="83" class="tabela1_titulo2">Escriba</td>
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2"><a href="#">
                        <?php=$atasreuniao[$i]->hora_inicio[0].$atasreuniao[$i]->hora_inicio[1]?>
                        :
                        <?php=$atasreuniao[$i]->hora_inicio[3].$atasreuniao[$i]->hora_inicio[4]?>
                      </a></td>
                      <td class="tabela1_linha2"><?php=$atasreuniao[$i]->hora_fim[0].$atasreuniao[$i]->hora_fim[1]?>
                        :
                          <?php=$atasreuniao[$i]->hora_fim[3].$atasreuniao[$i]->hora_fim[4]?></td>
                      <td class="tabela1_linha2" nowrap="nowrap" ><a href="#" onmouseover="doTooltip(event, 0, '<?php=$atasreuniao[$i]->assunto?>')" onmouseout="hideTip()">
                        <?php=substr($atasreuniao[$i]->assunto, 0, 10)?>
                        <?php  if(strlen($atasreuniao[$i]->assunto) >= 12){?>
                        ...
                        <?php  } ?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#" onmouseover="doTooltip(event, 0, '<?php=atasreuniaoDAO::findEscriba($atasreuniao[$i]->id, $atasreuniao[$i]->id_membroscondominio)?>')" onmouseout="hideTip()">
                        <?php=substr(atasreuniaoDAO::findEscriba($atasreuniao[$i]->id, $atasreuniao[$i]->id_membroscondominio), 0, 5)?>
                        <?php  if(strlen(atasreuniaoDAO::findEscriba( $atasreuniao[$i]->id, $atasreuniao[$i]->id_membroscondominio)) >= 5){?>
                        ...
                        <?php  } ?>
                      </a></td>
                      <td class="tabela1_linha2"><div align="center"><a href="#"></a> <a href="participante/home.php?ata=<?php=$atasreuniao[$i]->id?>"><img src="../images/lupa.jpg" width="20" height="21" border="0" /></a></div></td>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Assunto</td>
                        <td width="25%" class="tabela1_titulo2">Escriba</td>
                        <td width="26%" class="tabela1_titulo2">Data</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="assunto" id="assunto" class="FORMULARIO" type="text" size="20" value="<?php=$assunto?>" />                        </td>
                        <td nowrap="nowrap" class="tabela1_linha2">
                          <input name="escriba" id="escriba" class="FORMULARIO" type="text" size="15" value="<?php=$escriba?>" />                        </td>
