...
//verifica se o su possue permissão para visualizar(4) no modulo(22)
if(!permissoesDAO::temPermissao(22,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = funcionariosDAO::countByBusca($nome, $cpf, $id_condominio);
	

    $funcionarios = funcionariosDAO::findTopByBusca($nome, $cpf, $id_condominio, $nxt, $total_mural);
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Top 10  Funcionários do condomínio(ordem alfabética) </td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="34%" class="tabela1_titulo2">Funcionários do Condomínio</td>
                      <td width="23%" class="tabela1_titulo2">Login</td>
                      <td width="27%" class="tabela1_titulo2">Celular</td>
                      <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($funcionarios); $i++){
							if ($funcionarios[$i]->status == 0) { $classe = "tabela1_linhaWarning"; } else { $classe = "tabela1_linha2"; }	
						?>
                    <tr>
                      <td height="31" nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                        <?php=$funcionarios[$i]->nome?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$funcionarios[$i]->login?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$funcionarios[$i]->celular?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$funcionarios[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                      <td class="tabela1_linha2"><form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$funcionarios[$i]->nome?>','Membro do condomínio')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$funcionarios[$i]->id?>" name="id" />
                      </form></td>
                    </tr>
                     <?php 
							}
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem  funcionários do condomínio cadastrados
			</span></div>
			 <?php 	
				}}
			?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="40%" class="tabela1_titulo2">funcionário do Condomínio</td>
                        <td width="52%" class="tabela1_titulo2">CPF</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="nome" type="text" class="FORMULARIO" id="nome" value="<?php=$nome?>" size="25" />						</td>
                        <td class="tabela1_linha2" nowrap="nowrap"><input name="cpf" type="text" id="cpf" class="FORMULARIO" value="<?php=$cpf?>" size="11" maxlength="14" onkeypress="FormataCPF(this,event)" /></td>
