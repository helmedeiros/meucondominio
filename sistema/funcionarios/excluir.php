...
//verifica se o su possue permissão para excluir(3) no modulo(22)
if(!permissoesDAO::temPermissao(22,3,$usuario->id_tipo_usuario)){
...
if ( isset($_POST['id']) && is_numeric($_POST['id']) ){	
	funcionariosDAO::delete($_POST['id']);
}
...
if(!isset($nxt)||($nxt<0))
	...
	$total = funcionariosDAO::countByBusca("","",$id_condominio);
	

    $funcionarios = funcionariosDAO::findTopByBusca("","",$id_condominio,$nxt,$total_mural,"nome");
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="34%" class="tabela1_titulo2">Funcionário do Condomínio </td>
                        <td width="25%" class="tabela1_titulo2">Login</td>
                        <td width="32%" class="tabela1_titulo2">Celular</td>
						...
						?>
                      <tr>
                        <td height="31" nowrap="nowrap" class="<?php=$classe?>"><a href="#"><?php=$funcionarios[$i]->nome?></a></td>
                        <td class="<?php=$classe?>" nowrap="nowrap"><a href="#"><?php=$funcionarios[$i]->login?></a></td>
                        <td class="<?php=$classe?>" nowrap="nowrap"><a href="#"><?php=$funcionarios[$i]->celular?></a></td>
                        <td class="<?php=$classe?>" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$funcionarios[$i]->nome?>','Funcionário do Condomínio')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$funcionarios[$i]->id?>" name="id" /></form></td>
                      </tr>
					  	 <?php 
							}
						?>
