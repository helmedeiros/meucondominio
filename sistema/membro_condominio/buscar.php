...
//verifica se o su possue permissão para visualizar(4) no modulo(13)
if(!permissoesDAO::temPermissao(13,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = membroscondominioDAO::countByBusca($nome, $cpf, $id_condominio);
	

    $membros = membroscondominioDAO::findTopByBusca($nome, $cpf, $id_condominio, $nxt, $total_mural);
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      ...
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$membros[$i]->celular?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$membros[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="40%" class="tabela1_titulo2">Membro do Condomínio</td>
