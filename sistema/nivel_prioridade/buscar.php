...
//verifica se o su possue permissão para visualizar(4) no modulo(16)
if(!permissoesDAO::temPermissao(16,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = niveisprioridadeDAO::countByBusca($nome, $descricao);
	

    $niveisprioridades = niveisprioridadeDAO::findTopByBusca($nome, $descricao,$nxt,$total_mural);
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="29%" class="tabela1_titulo2">Nível de Prioridade </td>
                    ...
                    <tr>
                      ...
                      <td nowrap="nowrap" class="tabela1_linha2"><a href="#">
                        <?php=substr($niveisprioridades[$i]->descricao, 0, 50)?>
                        <?php  if(strlen($niveisprioridades[$i]->descricao) >= 50){?>
                        ...
                        <?php  }?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$niveisprioridades[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem níveis de prioridade cadastrados
			</span></div>
			 <?php 	
				}}
			?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Nível de Prioridade </td>
                        <td width="51%" class="tabela1_titulo2">Descricao</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="nome" id="nome" type="text" size="20" class="FORMULARIO" value="<?php=$nome?>" />
                        </td>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="descricao" id="descricao" class="FORMULARIO" type="text" size="20" value="<?php=$descricao?>" />
                        </td>
