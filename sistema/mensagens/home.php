                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="460">
                    ...
                    <?php 
						...
						?>
                    <tr>
					<td height="46" nowrap="nowrap" class="tabela1_linha2" ><a href="#" onmouseover="doTooltip(event, 0, '<?php=mensagensDAO::findAnunciante($mensagens[$i]->id, $mensagens[$i]->id_membroscondominio)?>')" onmouseout="hideTip()"><?php=substr(mensagensDAO::findAnunciante($mensagens[$i]->id, $mensagens[$i]->id_membroscondominio), 0, 15)?><?php  if(strlen(mensagensDAO::findAnunciante( $mensagens[$i]->id, $mensagens[$i]->id_membroscondominio)) >= 15){?>...<?php  } ?></a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#" onmouseover="doTooltip(event, 0, '<?php=$mensagens[$i]->mensagem?>')" onmouseout="hideTip()"><?php=substr($mensagens[$i]->mensagem, 0, 15)?><?php  if(strlen($mensagens[$i]->mensagem) >= 15){ ?>...<?php  } ?>  </a></td>
                      <td class="tabela1_linha2"><a href="#"><?php=$dias[date('w',strtotime($mensagens[$i]->data_envio))]?>, <?php=$mensagens[$i]->data_envio[8].$mensagens[$i]->data_envio[9]?>/<?php=$mensagens[$i]->data_envio[5].$mensagens[$i]->data_envio[6]?>
</a></td>
                      <td class="tabela1_linha2"><div align="center"><a href="#"></a> <a href="dest/home.php?atv=<?php=$mensagens[$i]->id?>"><img src="../images/lupa.jpg" width="20" height="21" border="0" /></a></div></td>
                    </tr>
                    <?php 
							}
						?>
