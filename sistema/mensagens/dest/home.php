...
if (isset($_GET['atv']) && $_GET['atv'] != "") {
	$total = destinatariosDAO::countAllByAtv($atv);
	$pau = destinatariosDAO::findTopByUsr($atv);
	if ($pau != "") $membrocondominio = membroscondominioDAO::findTopByTipo($id_condominio, $pau, $nxt,$total_mural);
	$paf = destinatariosDAO::findTopByFnc($atv);
...
$mensagens = mensagensDAO::findByPk($atv);
?>
        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="images/topo_espaco.jpg"><a href="adicionar.php?id=<?php=$atv?>"></a></td>
                <td valign="top" background="images/topo_espaco.jpg"><a href="#"></a></td>
                <td valign="top" background="images/topo_espaco.jpg"><a href="excluir.php?atv=<?php=$atv?>"></a></td>
              </tr>
          </table></td>
      </tr>
      <tr>
        <td height="71" background="../../images/topo_box.jpg"><!-- titulo da secao -->
          <h1>DESTINATÁRIO</h1></td>
      </tr>
    </table>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <br />
			 <div align="center" class="fontelinkPreto">
			   ...
			   Mensagem -&gt;<a href="../home.php" onmouseover="doTooltip(event, 0, '<?php=$mensagens->mensagem?>')" onmouseout="hideTip()"><?php=substr($mensagens->mensagem, 0, 15)?><?php  if(strlen($mensagens->mensagem) >= 15){ ?>...<?php  } ?></a><br />

			   <?php  if (isset($flg)) { 
			     switch ($flg) {
    				case 1: ?>Destinatário -> <a href="">Membros do Condomínio</a>
                    <?php  break;
                   case 2: ?>Destinatário -> <a href="">Funcionários do Condomínio</a>
                <?php 	break; } }?>
			 ...
			 <div align="center">
			   ...
			   <p>
			   <?php  if (!isset($flg)) { ?>
			    <a href="home.php?atv=<?php=$atv?>&flg=1"> Membros do Condomínio</a> (fazer imagem) </p>
			   <p><a href="home.php?atv=<?php=$atv?>&flg=2">Funcionários do Condomínio </a> </p> <?php  } ?>
			     <?php 
			 ...
			 <table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
                <tr>
                  <td width="460" bgcolor="#6598CB"><table width="460" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="407" class="tabela1_titulo1">Top 10  Destinatários (ordem alfabética)</td>
