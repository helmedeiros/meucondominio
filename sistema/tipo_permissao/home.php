            ...
            <table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
                <tr>
                  <td width="460" bgcolor="#6598CB"><table width="460" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="407" class="tabela1_titulo1">Top 10  Tipos de Permissões(ordem alfabética) </td>
                  ...
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      ...
                      <td nowrap="nowrap" class="tabela1_linha2"><a href="#">
                        <?php=substr($tiposPermissoes[$i]->descricao, 0, 50)?><?php  if(strlen($tiposPermissoes[$i]->descricao) >= 50){?>...<?php  }?></a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$tiposPermissoes[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                    <?php 
							}
						?>
