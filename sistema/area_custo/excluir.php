...
//verifica se o su possue permissão para excluir(3) em areas de custos(30)
if(!permissoesDAO::temPermissao(30,3,$usuario->id_tipo_usuario)){
...
if(!isset($nxt)||($nxt<0))
	...
	$total = areacustosDAO::countAll();
	

    $areacustos = areacustosDAO::findTop($nxt,$total_mural);
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Top 10  Áreas de Custos(ordem alfabética) </td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="31%" class="tabela1_titulo2">Nome</td>
                        <td width="30%" class="tabela1_titulo2">Tipo</td>
                        <td width="28%" class="tabela1_titulo2">&nbsp;</td>
                        <td width="11%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>
					    <?php 
							for ($i = 0; $i < sizeof($areacustos); $i++){
						?>
                      <tr>
                        <td height="35" nowrap="nowrap" class="tabela1_linha2"><a href="#">
                          <?php=$areacustos[$i]->nome?>
                        </a></td>
                        <td nowrap="nowrap" class="tabela1_linha2"><a href="#">
                          <?php=$areacustos[$i]->tipo?>
                        </a></td>
                        ...
                        <td class="tabela1_linha2" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$areacustos[$i]->nome?>','Área de Custo')">
                          <input type="hidden" value="<?php=$areacustos[$i]->id?>" name="id" />
