...
if ( isset($_POST['id']) && is_numeric($_POST['id']) ){
	centrocustosDAO::delete($_POST['id']);}
...
if ( isset($area) && is_numeric($area) ){
	$total = centrocustosDAO::countAll($area);
	$areacustos = areacustosDAO::findByPk($area);
	$centrocustos = centrocustosDAO::findTOP($area, $nxt,$total_mural);}
        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="images/topo_espaco.jpg"><a href="excluir.php?area=<?php=$area?>"><img src="../../images/botao_excluir.jpg" name="excluir1" width="87" height="40" border="0" id="excluir1" /></a></td>
          </table></td>
      </tr>
      <tr>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
                <tr>
                  <td width="460" bgcolor="#6598CB"><table width="460" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="407" class="tabela1_titulo1">Centros de Custos Cadastrados para: <?php=$areacustos->nome;?></td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="12%" class="tabela1_titulo2">Número</td>
                      <td width="73%" class="tabela1_titulo2">Nome </td>
                      <td width="15%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
                    ...
                    <tr>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$centrocustos[$i]->numero?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$centrocustos[$i]->nome?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><div align="center">
                        <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$centrocustos[$i]->nome?>','Centro de Custo')">
						<input type="image" src="../../images/xis.jpg" width="20" height="21" border="0" />
						<input type="hidden" value="<?php=$centrocustos[$i]->id?>" name="id" /><input type="hidden" value="<?php=$area?>" name="area"/></form>
                      </div></td>
                    </tr>
                    <?php 
							}
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem Centro de Custos Cadastrados
			</span></div>
			 <?php 	
				}
			?>
