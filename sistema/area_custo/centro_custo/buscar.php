...
//verifica se o su possue permissão para visualizar(4) no centro de custo(26)
if(!permissoesDAO::temPermissao(26,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	if(!isset($nxt)||($nxt<0))
	{
		...
		//quantos por pagina
	$total_mural = 10;
	$total = centrocustosDAO::countByBusca($nome, $numero, $area);
	$centrocustos = centrocustosDAO::findTopByBusca($nome, $numero, $area, $nxt, $total_mural);
...
<table width="714" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <td valign="top" background="images/topo_espaco.jpg"><a href="home.php?area=<?php=$area?>"><img src="../../images/botao_listar_off.jpg" name="listar1" width="78" height="40" border="0" id="listar1" /></a></td>
				<td valign="top" background="images/topo_espaco.jpg"><a href="buscar.php?area=<?php=$area?>"><img src="../../images/botao_pesquisar.jpg" name="pesquisar" width="90" height="40" border="0" id="listar1" /></a></td>
                <td valign="top" background="images/topo_espaco.jpg"><a href="adicionar.php?area=<?php=$area?>"><img src="../../images/botao_cadastrar_off.jpg" name="cadastrar1" width="87" height="40" border="0" id="cadastrar1" /></a></td>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Top 10 Centros de Custo(ordem alfabética) </td>
                        <td width="11%"><a href="home.php?area=<?php=$_GET['area']?>"><img src="../../images/listar.jpg" width="48" height="17" border="0" /></a></td>
                      </tr>
                  </table></td>
                </tr>
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="13%" class="tabela1_titulo2">Numero</td>
                      <td width="79%" class="tabela1_titulo2">Nome</td>
                      <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($centrocustos); $i++){
						?>
                    <tr>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#"><?php=$centrocustos[$i]->numero?>
                      </a></td>
                      <td nowrap="nowrap" class="tabela1_linha2"><a href="#">
                        <?php=$centrocustos[$i]->nome?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?area=<?php=$area?>&id=<?php=$centrocustos[$i]->id?>"><img src="../../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem Centros de Custos cadastradas
			</span></div>
			 <?php 	
				}}
			?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1"><p>Busca Centro de Custos inseridos em: <?php=$areacustos->nome;?>
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Numero</td>
                        <td width="51%" class="tabela1_titulo2">Nome</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="numero" id="numero" class="FORMULARIO" type="text" size="20" value="<?php=$numero?>" /></td>
                        <td class="tabela1_linha2" nowrap="nowrap"><input name="nome" id="nome" class="FORMULARIO" type="text" size="20" value="<?php=$nome?>" /></td>
