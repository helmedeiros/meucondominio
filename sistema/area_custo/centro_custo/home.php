...
//verifica se o su possue permissão para visualizar(4) em centro de custo(26)
        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="images/topo_espaco.jpg"><a href="home.php?area=<?php=$area?>"><img src="../../images/botao_listar.jpg" name="listar1" width="78" height="40" border="0" id="listar1" /></a></td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      ...
                      <td width="81%" class="tabela1_titulo2">Nome </td>
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2" nowrap="nowrap"><div align="center"><a href="adicionar.php?area=<?php=$area?>&id=<?php=$centrocustos[$i]->id?>"><img src="../../images/mais.jpg" width="20" height="21" border="0" /></a>
