...
if($titulo != "" or $responsavel != "" or $data != ""){
	$find = 1;
}
...
if($find == 1){		
	...
	//quantos por pagina
	$total_mural = 10;
	$total = atividadesDAO::countByBusca($titulo, $data, $responsavel);
	$atividades = atividadesDAO::findTopByBusca($titulo, $data, $responsavel, $nxt, $total_mural);
			...
			<table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="460">
                    <tr>
                      <td width="89" class="tabela1_titulo2">Responsável</td>
                      <td width="81" class="tabela1_titulo2">Atividade</td>
                      <td width="91" class="tabela1_titulo2">Data de Realização</td>
                      <td width="71" class="tabela1_titulo2">Prioridade</td>
                    ...
                    <?php 
						...
						?>
                    <tr>
                      <td class="tabela1_linha2" nowrap="nowrap" ><a href="#" onmouseover="doTooltip(event, 0, '<?php=atividadesDAO::findAnunciante($atividades[$i]->id, $atividades[$i]->id_membroscondominio)?>')" onmouseout="hideTip()">
                        <?php=substr(atividadesDAO::findAnunciante($atividades[$i]->id, $atividades[$i]->id_membroscondominio), 0, 15)?>
                        <?php  if(strlen(atividadesDAO::findAnunciante( $atividades[$i]->id, $atividades[$i]->id_membroscondominio)) >= 15){?>
                        ...
                        <?php  } ?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#" onmouseover="doTooltip(event, 0, '<?php=$atividades[$i]->titulo?>')" onmouseout="hideTip()">
                        <?php=substr($atividades[$i]->titulo, 0, 15)?>
                        <?php  if(strlen($atividades[$i]->titulo) >= 15){ ?>
                        ...
                        <?php  } ?>
                      </a></td>
                      <td class="tabela1_linha2"><a href="#">
                        <?php=$dias[date('w',strtotime($atividades[$i]->data_realizacao))]?>
                        ,
                        <?php=$atividades[$i]->data_realizacao[8].$atividades[$i]->data_realizacao[9]?>
                        /
                        <?php=$atividades[$i]->data_realizacao[5].$atividades[$i]->data_realizacao[6]?>
                      </a></td>
                      <td class="tabela1_linha2"><?php  $np = niveisprioridadeDAO::findByPk($atividades[$i]->id_prioridade); ?>
                          <?php=$np->nome;?></td>
                      <td class="tabela1_linha2"><a href="#"></a> <a href="pubalvo/home.php?atv=<?php=$atividades[$i]->id?>"><img src="../images/lupa.jpg" width="20" height="21" border="0" /></a></td>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Título</td>
                        <td width="25%" class="tabela1_titulo2">Responsável</td>
                        <td width="26%" class="tabela1_titulo2">Data</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="titulo" id="titulo" class="FORMULARIO" type="text" size="20" value="<?php=$titulo?>" />                        </td>
                        <td nowrap="nowrap" class="tabela1_linha2">
                          <input name="responsavel" id="responsavel" class="FORMULARIO" type="text" size="15" value="<?php=$responsavel?>" />                        </td>
