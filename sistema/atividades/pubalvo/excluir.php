...
//verifica se o su possue permissão para excluir(4) em areas de cuso(30)
...
if (isset($_GET['atv']) && $_GET['atv'] != "") {
	...
	$publico_alvo = publico_alvoDAO::findTopByAtv($atv, $nxt,$total_mural);
	}

if ( isset($_POST['id']) && is_numeric($_POST['id']) ){
   publico_alvoDAO::delete($_POST['id'], $_POST['at']);
   header("Location: home.php?atv=$atv");
	exit();
  }
        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="images/topo_espaco.jpg"><a href="home.php?atv=<?php=$atv?>"><img src="../../images/botao_listar_off.jpg" name="listar1" width="78" height="40" border="0" id="listar1" /></a></td>
				<td valign="top" background="images/topo_espaco.jpg"><a href="buscar.php"></a></td>
                <td valign="top" background="images/topo_espaco.jpg"><a href="adicionar.php?id=<?php=$atv?>"><img src="../../images/botao_cadastrar_off.jpg" name="cadastrar1" width="87" height="40" border="0" id="cadastrar1" /></a></td>
			...
			<table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
              <tr>
                <td width="460" bgcolor="#6598CB"><table width="460" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="407" class="tabela1_titulo1">Top 10  Público Alvo (ordem alfabética) </td>
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="460">
                    <tr>
                      <td width="169" class="tabela1_titulo2">Nome </td>
                      <td width="136" class="tabela1_titulo2">Telefone </td>
                      <td width="120" class="tabela1_titulo2">N. Apto.</td>
                      <td width="20" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($publico_alvo); $i++){
							$membrocondominio = membroscondominioDAO::findByPk($publico_alvo[$i]->id_membroscondominio);
							switch ($publico_alvo[$i]->compareceu) {
							 case 2: 
							      $class = "tabela1_linhaYellow";
								  break;
						     case 1:
							      $class = "tabela1_linhaGreen";
								  break;
						     case 0:
							      $class = "tabela1_linhaWarning";
								  break;	
							default: 
							   $class = "tabela1_linha2";
							     break;
							}  						         
						?>
                    <tr>
                      <td class="<?php=$class?>" nowrap="nowrap" ><a href="#">
                        <?php=$membrocondominio->nome?>
                      </a></td>
                      <td class="<?php=$class?>"><a href="#">
                        <?php=$membrocondominio->telefone?>
                      </a></td>
                      <td class="<?php=$class?>"><a href="#">
                        <?php=$membrocondominio->numero_apartamento?>
                      </a><a href="#"></a></td>
                      <td class="<?php=$class?>"><form action="excluir.php?atv=<?php=$atv?>" method="post" onsubmit="javascript:return confirma('a','participante')">
                        <input type="hidden" value="<?php=$publico_alvo[$i]->id_membroscondominio?>" name="id" />
                        <input type="hidden" value="<?php=$publico_alvo[$i]->id_atividades?>" name="at" />
