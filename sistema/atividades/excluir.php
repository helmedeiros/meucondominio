...
if ( isset($_POST['id']) && is_numeric($_POST['id']) ){
  atividadesDAO::delete($_POST['id']);
  publico_alvoDAO::delete($_POST['id']);
  }
			...
			<table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
              ...
              <tr>
                <td><table cellpadding="1" cellspacing="1" width="460">
                    <tr>
                      <td width="112" class="tabela1_titulo2">Anunciante</td>
                      <td width="94" class="tabela1_titulo2">Atividade</td>
                      <td width="134" class="tabela1_titulo2">Data de Realização</td>
                      <td width="71" class="tabela1_titulo2">Público Alvo </td>
                    ...
                    <?php 
						...
						?>
                    <tr>
                      <td height="77" nowrap="nowrap" class="tabela1_linha2" ><a href="#" onmouseover="doTooltip(event, 0, '<?php=atividadesDAO::findAnunciante($atividades[$i]->id, $atividades[$i]->id_membroscondominio)?>')" onmouseout="hideTip()">
                      ...
                      <td class="tabela1_linha2"><div align="center"><a href="#"></a> <a href="pubalvo/home.php?atv=<?php=$atividades[$i]->id?>"><img src="../images/lupa.jpg" width="20" height="21" border="0" /></a></div></td>
                      <td class="tabela1_linha2"><form action="excluir.php" method="post" onsubmit="javascript:return confirma('<?php=$atividades[$i]->titulo?>','Atividade')">             <input type="hidden" value="<?php=$atividades[$i]->id?>" name="id" />
