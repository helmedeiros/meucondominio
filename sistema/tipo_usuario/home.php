            ...
            <table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
                <tr>
                  <td width="460" bgcolor="#6598CB"><table width="460" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="407" class="tabela1_titulo1">Top 10  Tipos de Usuários(ordem alfabética) </td>
                  ...
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      ...
                      <td nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                        <?php=substr($tiposUsuarios[$i]->descricao, 0, 40)?><?php  if(strlen($tiposUsuarios[$i]->descricao) >= 40){?>...<?php  }?></a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="adicionar.php?id=<?php=$tiposUsuarios[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                    <?php 
							}
						?>
