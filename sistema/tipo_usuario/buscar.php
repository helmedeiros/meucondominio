...
//verifica se o su possue permissão para visualizar(4) no modulo(4)
if(!permissoesDAO::temPermissao(4,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = tiposusuariosDAO::countByBusca($nome, $descricao);
	

    $tipousuarios = tiposusuariosDAO::findTopByBusca($nome, $descricao,$nxt,$total_mural);
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <?php 
							for ($i = 0; $i < sizeof($tipousuarios); $i++){
                    ...
                    <tr>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$tipousuarios[$i]->id?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$tipousuarios[$i]->nome?>
                      </a></td>
                      <td nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                        <?php=substr($tipousuarios[$i]->descricao, 0, 40)?>
                        <?php  if(strlen($tipousuarios[$i]->descricao) >= 40){?>
                        ...
                        <?php  }?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="adicionar.php?id=<?php=$tipousuarios[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                   <?php 
							}
						?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Tipo de Usuário</td>
