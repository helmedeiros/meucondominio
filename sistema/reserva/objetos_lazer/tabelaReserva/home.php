        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="../../../area_lazer/centro_custo/images/topo_espaco.jpg"><a href="home.php?area=<?php=$area?>&objeto=<?php=$objeto?>"><img src="../../../images/botao_listar.jpg" name="listar1" width="78" height="40" border="0" id="listar1" /></a></td>
