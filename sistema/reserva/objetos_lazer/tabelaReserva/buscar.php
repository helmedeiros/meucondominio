        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
				...
				<td valign="top" background="../../../area_lazer/centro_custo/images/topo_espaco.jpg"><a href="buscar.php?area=<?php=$area?>&objeto=<?php=$objeto?>"><img src="../../../images/botao_pesquisar.jpg" name="pesquisar" width="90" height="40" border="0" id="listar1" /></a></td>
...
<table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
						...
						?>	<?php=$membro->nome?> / <?php=$membro->numero_apartamento?>
						<?php  }else{?>
							-
						<?php  }?>
						</div></td>
			...
			<br />
			<br />
              </p><table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                ...
                <tr>
                  <td>
				  <form onsubmit="return checa_formulario(this)" action="buscar.php" method="post" >
				  <table cellpadding="1" cellspacing="1" width="100%">
                      ...
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap"><select name="dia">
                          ...
                          <input type="hidden" name="objeto" value="<?php=$objetos->id?>" /></td>
