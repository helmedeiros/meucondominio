...
//verifica se o su possue permissão para excluir(3) no modulo(21)
if(!permissoesDAO::temPermissao(21,3,$usuario->id_tipo_usuario)){
...
if ( isset($_POST['id']) && is_numeric($_POST['id']) )
	tiposfuncionariosDAO::delete($_POST['id']);
...
if(!isset($nxt)||($nxt<0))
	...
	$total = tiposfuncionariosDAO::countAll();
	

    $tiposFuncionarios = tiposfuncionariosDAO::findTop($nxt,$total_mural);
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="28%" class="tabela1_titulo2">Tipo de Funcionário </td>
						...
						?>
                      <tr>
                        <td height="31" nowrap="nowrap" class="<?php=$classe?>"><a href="#"><?php=$tiposFuncionarios[$i]->nome?></a></td>
                        <td nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                        <?php=substr($tiposFuncionarios[$i]->descricao, 0, 50)?><?php  if(strlen($tiposFuncionarios[$i]->descricao) >= 50){?>...<?php  }?></a></td>
                        <td class="<?php=$classe?>" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$tiposFuncionarios[$i]->nome?>','Tipo de Funcionário')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$tiposFuncionarios[$i]->id?>" name="id" /></form></td>
                      </tr>
					  	 <?php 
							}
						?>
