...
//verifica se o su possue permissão para visualizar(4) no modulo(21)
if(!permissoesDAO::temPermissao(21,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = tiposfuncionariosDAO::countByBusca($nome, $descricao);
	

    $tiposfuncionarios = tiposfuncionariosDAO::findTopByBusca($nome, $descricao,$nxt,$total_mural);
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="29%" class="tabela1_titulo2">Tipo de Funcionário </td>
                      <td width="64%" class="tabela1_titulo2">Descrição</td>
                      <td width="7%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($tiposfuncionarios); $i++){
							if ($tiposFuncionarios[$i]->status == 0) { $classe = "tabela1_linhaWarning"; } else { $classe = "tabela1_linha2"; }
						?>
                    <tr>
                      ...
                      <td nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                        <?php=substr($tiposfuncionarios[$i]->descricao, 0, 50)?>
                        <?php  if(strlen($tiposfuncionarios[$i]->descricao) >= 50){?>
                        ...
                        <?php  }?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="adicionar.php?id=<?php=$tiposfuncionarios[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem tipos de funcionários cadastrados
			</span></div>
			 <?php 	
				}}
			?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Tipo de Funcionário </td>
                        <td width="51%" class="tabela1_titulo2">Descricao</td>
                        <td width="8%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="nome" id="nome" type="text" class="FORMULARIO" size="20" value="<?php=$nome?>" /></td>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="descricao" id="descricao" class="FORMULARIO" type="text" size="20" value="<?php=$descricao?>" /></td>
