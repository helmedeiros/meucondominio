...
if(!isset($nxt)||($nxt<0))
	...
	$total = ServidorDAO::countAll();
	

    $servidores = ServidorDAO::findTop($nxt,$total_mural);
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      ...
                      <tr>
                        ...
                        <td class="<?php=$classe?>" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$servidores[$i]->nome_servidor?>','Prestadores de Serviços')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$servidores[$i]->id?>" name="id" /></form></td>
                      </tr>
					   <?php 
							}
						?>
