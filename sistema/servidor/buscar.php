...
//verifica se o su possue permissão para visualizar(4) no modulo(29)
if(!permissoesDAO::temPermissao(29,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = ServidorDAO::countByBusca($nome, $cpf, $cnpj);
	

    $servidores = ServidorDAO::findTopByBusca($nome, $cpf, $cnpj,$nxt,$total_mural);
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Top 10  Prestadores de Serviço (ordem alfabética) </td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="28%" class="tabela1_titulo2">Prestador de Serviço </td>
                      <td width="22%" class="tabela1_titulo2">Contato</td>
                      <td width="43%" class="tabela1_titulo2">Celular</td>
                      <td width="7%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($servidores); $i++){
								if ($servidores[$i]->status == 0) { $classe = "tabela1_linhaWarning"; } else { $classe = "tabela1_linha2"; }
						?>
                    <tr>
                      ...
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$servidores[$i]->nome_contato?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$servidores[$i]->celular_contato?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="adicionar.php?id=<?php=$servidores[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                    <?php 
							}
						?>
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem prestadores de seriço cadastrados
			</span></div>
			 <?php 	
				}}
			?>
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="28%" class="tabela1_titulo2">Prestador de Serviço </td>
                        <td width="22%" class="tabela1_titulo2">CPF</td>
                        <td width="43%" class="tabela1_titulo2">CNPJ</td>
                        <td width="7%" class="tabela1_titulo2">&nbsp;</td>
                      </tr>                   
                      <tr>
                        ...
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="cpf" type="text" id="cpf" class="FORMULARIO" value="<?php=$cpf?>" size="11" maxlength="14" onkeypress="FormataCPF(this,event)" />
                        </td>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="cnpj" type="text" id="cnpj" class="FORMULARIO" value="<?php=$cnpj?>" size="14" maxlength="18" onkeypress="FormataCNPJ(this,event)" />
                        </td>
