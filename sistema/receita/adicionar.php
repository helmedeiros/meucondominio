...
if ( isset($_POST['valor']) ){	
	...
	if ($receita->id == 0){	
		...
		if(ReceitaDespesaDAO::existeByCondominioTipoAreaDocumentoCentro($receita->id_condominio, 'receita', $receita->documento, $receita->id_centro)){
			$receita = ReceitaDespesaDAO::findTopByBuscafindTopByBusca("", "", "", $receita->id_condominio, 'receita', "", 0, 0, 1,  "", $receita->documento);
		...
		if((ReceitaDespesaDAO::existeByCondominioTipoAreaDocumentoCentro($receita->id_condominio, 'receita', $receita->documento, $receita->id_centro)) && (ReceitaDespesaDAO::existeByCondominioTipoAreaDocumentoCentroId($receita->id_condominio, 'receita', $receita->documento, $receita->id_centro, $receita->id))) {
		...
		$msg = 'O centro de custo a qual se quer inserir um registro não permite novas entradas';
	}
	}else{
...
$centros = centrocustosDAO::findByTipoArea('receita');
$pontinhos = "../";
?>
			  ...
			  <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
					  ...
					  <tr>
					    <td class="tabela1_linha2"  align="right"><span class="verdanaMarron">Valor</span></td>
					  ...
					  <tr>
				        ...
				        <span class="warning"><?php  if($receita->recebido_pago == 1){?> * <?php  }?></span>
						 <?php  if($receita->recebido_pago == 1){?> <input type="hidden" name="pagante_fornecedor" id="pagante_fornecedor" value="<?php=stripslashes($receita->pagante_fornecedor)?>" /><?php  }?>
						</td>
				      </tr>
					   <tr>
                        <td class="tabela1_linha2"  align="right"><span class="verdanaMarron">Valor Recebido</span></td>
					   ...
					   <tr>
					     <td  align="right" class="tabela1_linha2">Recebido</td>
					  ...
					  <tr>
					  	<td align="right" class="tabela1_linha2" colspan="2"><div align="left"><span class="warning">* Os campos não podem ser alterados após o recebimento </span></div></td> 
					  </tr>
					  <?php  }?>
					  <tr>
