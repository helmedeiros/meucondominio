...
if(!permissoesDAO::temPermissao(1,4,$usuario->id_tipo_usuario)){
...
if($find == 1){		
	...
	$total = SuperUsuarioDAO::countByBusca($nome, $login, $celular);
	

    $usuarios = SuperUsuarioDAO::findTopByBusca($nome, $login, $celular,$nxt,$total_mural);
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$usuarios[$i]->login?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$usuarios[$i]->celular?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$usuarios[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                     <?php 
							}
						?>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      ...
                      <tr>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="nome" id="nome" type="text" size="18" value="<?php=$nome?>" />
						</td>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="login" id="login" type="text" size="18" value="<?php=$login?>" />
                        </td>
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <input name="celular" id="celular" type="text" value="<?php=$celular?>" size="14" maxlength="14" onkeypress="FormataTEL(this,event)"/>
                        </td>
