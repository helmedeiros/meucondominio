...
//verifica se o su possue permissão para excluir(3) no modulo(1)
if(!permissoesDAO::temPermissao(1,3,$usuario->id_tipo_usuario)){
...
if ( isset($_POST['id']) && is_numeric($_POST['id']) )
	SuperUsuarioDAO::delete($_POST['id']);
...
if(!isset($nxt)||($nxt<0))
	...
	$total = SuperUsuarioDAO::countAll();
	

    $usuarios = SuperUsuarioDAO::findTop($nxt,$total_mural);
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="28%" class="tabela1_titulo2">Super-Usuário</td>
                        <td width="22%" class="tabela1_titulo2">Login</td>
						...
						?>
                      <tr>
                        <td height="31" nowrap="nowrap" class="tabela1_linha2"><a href="#"><?php=$usuarios[$i]->nome?></a></td>
                        <td class="tabela1_linha2" nowrap="nowrap"><a href="#"><?php=$usuarios[$i]->login?></a></td>
                        <td class="tabela1_linha2" nowrap="nowrap"><a href="#"><?php=$usuarios[$i]->celular?></a></td>
                        <td class="tabela1_linha2" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$usuarios[$i]->nome?>','Super-Usuário')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$usuarios[$i]->id?>" name="id" /></form></td>
                      </tr>
					  	 <?php 
							}
						?>
