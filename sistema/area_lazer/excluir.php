...
//verifica se o su possue permissão para excluir(3) no modulo(19)
if(!permissoesDAO::temPermissao(19,3,$usuario->id_tipo_usuario)){
...
if(!isset($nxt)||($nxt<0))
	...
	$total = arealazerDAO::countByBusca("","",$id_condominio);
	

    $areas = arealazerDAO::findTopByBusca("","",$id_condominio,$nxt,$total_mural,"nome");
      ...
      <table width="545" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="33%" class="tabela1_titulo2">Área de Lazer </td>
                        <td width="24%" class="tabela1_titulo2">Situação</td>
                        <td width="34%" class="tabela1_titulo2">&nbsp;</td>
                      ...
                      <tr>
                        ...
                        <td class="<?php=$classe?>" nowrap="nowrap"><div align="center">
                        <div align="center"><a href="objetos_lazer/home.php?area=<?php=$areas[$i]->id?>"><img src="../images/objetosdelazer.jpg" alt="objetos de lazer" width="120" height="21" border="0" /></a></div></td>
			...
			?>
			 <div align="center"><span class="verdanaAzul">Não existem áreas de lazer cadastrados</span></div>
			 <?php 	
				}
			?>
