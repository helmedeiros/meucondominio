...
//verifica se o su possue permissão para visualizar(4) em areas de cuso(20)
...
if ( isset($_POST['id']) && is_numeric($_POST['id']) ){
	objetolazerDAO::delete($_POST['id']);}
        ...
        <td><!-- menu superior -->
            <table width="545" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td valign="top" background="../centro_custo/images/topo_espaco.jpg"><a href="adicionar.php?area=<?php=$area?>"><img src="../../images/botao_cadastrar_off.jpg" name="cadastrar1" width="87" height="40" border="0" id="cadastrar1" /></a></td>
                <td valign="top" background="../centro_custo/images/topo_espaco.jpg"><a href="#"></a></td>
                <td valign="top" background="../centro_custo/images/topo_espaco.jpg"><a href="excluir.php?area=<?php=$area?>"><img src="../../images/botao_excluir.jpg" name="excluir1" width="87" height="40" border="0" id="excluir1" /></a></td>
          </table></td>
      </tr>
      <tr>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      ...
                      <td width="48%" class="tabela1_titulo2">Situação</td>
                      <td width="10%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2" nowrap="nowrap"><div align="center">
                        <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$objetos[$i]->nome?>','Objetos de Lazer')">
						<input type="image" src="../../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$objetos[$i]->id?>" name="id" /><input type="hidden" value="<?php=$area?>" name="area"/></form>
                      </div></td>
                    </tr>
                    <?php 
							}
