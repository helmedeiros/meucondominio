            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="45%" class="tabela1_titulo2">Objeto de Lazer </td>
                      <td width="47%" class="tabela1_titulo2">Situação</td>
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?area=<?php=$area?>&amp;id=<?php=$objetos[$i]->id?>"><img src="../../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$objetos[$i]->nome?>','Objetos de Lazer')">
						<input type="image" src="../../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$objetos[$i]->id?>" name="id" /><input type="hidden" value="<?php=$area?>" name="area"/></form></td>
                    </tr>
                     <?php 
							}
						?>
