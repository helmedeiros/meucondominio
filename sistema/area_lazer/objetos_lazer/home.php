...
if ( isset($area) && is_numeric($area) ){
	...
	$areas = arealazerDAO::findByPk($_GET['area']);
            ...
            <table width="96%" cellpadding="0" cellspacing="0" class="tabela1">
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      <td width="46%" class="tabela1_titulo2">Objeto de Lazer </td>
                    ...
                    <tr>
                      ...
                      <td class="tabela1_linha2" nowrap="nowrap"><div align="center"><a href="adicionar.php?area=<?php=$area?>&id=<?php=$objetos[$i]->id?>"><img src="../../images/mais.jpg" width="20" height="21" border="0" /></a>
