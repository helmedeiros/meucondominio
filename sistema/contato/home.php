...
//verifica se o su possue permissão para visualizar(4) no modulo(36)
if(!permissoesDAO::temPermissao(36,4,$usuario->id_tipo_usuario)){
        ...
        <tr>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
			...
			?>
		 	...
		 	Não existe nenhum cotato  cadastrados para o condomínio </span> </div>
			 <?php 	
				}
			?>
