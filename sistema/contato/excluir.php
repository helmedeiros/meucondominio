...
//verifica se o su possue permissão para excluir(3) no modulo(29)
if(!permissoesDAO::temPermissao(29,3,$usuario->id_tipo_usuario)){
...
if ( isset($_POST['id']) && is_numeric($_POST['id']) ){
	//verifica se o contato esta associado a mais algum condominio pois caso não esteja pode ser deletado definitivamente, caso contrário este e apenas desmarcado como contato para o condomínio atual.
	if(!condominiosDAO::existByContatoId($_POST['id'],$id_condominio)){
		contatosDAO::delete($_POST['id']);
	}
...
if(!isset($nxt)||($nxt<0))
	...
	$total = contatosDAO::countByBusca("","",$id_condominio);
	

    $contatos = contatosDAO::findTopByBusca("","",$id_condominio,$nxt,$total_mural,"nome");
      ...
      <table width="545" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Top 1 Contatos </td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="42%" class="tabela1_titulo2">Contato</td>
                        <td width="25%" class="tabela1_titulo2">CPF</td>
                        <td width="25%" class="tabela1_titulo2">Celular</td>
                      ...
                      <tr>
                        ...
                        <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                          <?php=$contatos[$i]->celular?>
                        </a></td>
                        <td class="tabela1_linha2" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$contatos[$i]->nome?>','Contato')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$contatos[$i]->id?>" name="id" /></form></td>
                      </tr>
					   <?php 
							}
						?>
			...
			?>
			 <div align="center"><span class="verdanaAzul">Não existe nenhum cotato  cadastrados para o condomínio</span></div>
			 <?php 	
				}
			?>
