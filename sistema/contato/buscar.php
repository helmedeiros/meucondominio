...
if($find == 1){		
	...
	$total = contatosDAO::countByBusca($nome, $cpf, $cnpj);
	

    $contatos = contatosDAO::findTopByBusca($nome, $cpf, $cnpj,$nxt,$total_mural);
                  ...
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    ...
                    <tr>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$contatos[$i]->nome_servidor?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$contatos[$i]->nome_contato?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="#">
                        <?php=$contatos[$i]->celular_contato?>
                      </a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$contatos[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                    <?php 
							}
						?>
