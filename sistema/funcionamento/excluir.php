...
//verifica se o su possue permissão para excluir(3) no modulo(37)
if(!permissoesDAO::temPermissao(37,3,$usuario->id_tipo_usuario)){
...
if ( isset($_POST['id']) && is_numeric($_POST['id']) )
	funcionamentoDAO::delete($_POST['id']);
...
if(!isset($nxt)||($nxt<0))
	...
	$total = funcionamentoDAO::countAll();
	

    $funcionamentos = funcionamentoDAO::findTop($nxt,$total_mural);
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                      ...
                      <tr>
                        ...
                        <td class="tabela1_linha2" nowrap="nowrap"> <form action="excluir.php" method="post" onSubmit="javascript:return confirma('<?php=$funcionamentos[$i]->nome?>','Situaçao de Funcionamento')"><input type="image" src="../images/xis.jpg" width="20" height="21" border="0" /><input type="hidden" value="<?php=$funcionamentos[$i]->id?>" name="id" /></form></td>
                      </tr>
					  	<?php 
							}
						?>
