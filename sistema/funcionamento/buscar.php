...
//verifica se o su possue permissão para visualizar(4) no modulo(37)
if(!permissoesDAO::temPermissao(37,4,$usuario->id_tipo_usuario)){
...
if (isset($_GET['impedimento'])){
		$impedimento = $_GET['impedimento'];
}else{
...
if($find == 1){		
	...
	$total = funcionamentoDAO::countByBusca($nome, $impedimento);
	

    $funcionamentos = funcionamentoDAO::findTopByBusca($nome, $impedimento,$nxt,$total_mural);
          ...
          <td width="481" bgcolor="#FFFFFF"><!-- texto sempre dentro da tag "<p>" -->
            ...
            <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                <tr>
                  <td bgcolor="#6598CB"><table width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="89%" class="tabela1_titulo1">Top 10  Situações de Funcionamento(ordem alfabética) </td>
                ...
                <tr>
                  <td><table cellpadding="1" cellspacing="1" width="100%">
                    <tr>
                      ...
                      <td width="36%" class="tabela1_titulo2">Situação de Funcionamento </td>
                      <td width="49%" class="tabela1_titulo2">Impedimento</td>
                      <td width="7%" class="tabela1_titulo2">&nbsp;</td>
                    </tr>
                    <?php 
							for ($i = 0; $i < sizeof($funcionamentos); $i++){
								if ($funcionamentos[$i]->status == 0) { $classe = "tabela1_linhaWarning"; } else { $classe = "tabela1_linha2"; }
						?>
                    <tr>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$funcionamentos[$i]->id?>
                      </a></td>
                      <td class="<?php=$classe?>" nowrap="nowrap"><a href="#">
                        <?php=$funcionamentos[$i]->nome?>
                      </a></td>
                      <td nowrap="nowrap" class="<?php=$classe?>"><a href="#">
                      	<?php  if($funcionamentos[$i]->impedimento == 1){?>
							Sim
						<?php  }else{?>
							Não
						<?php  }?></a></td>
                      <td class="tabela1_linha2" nowrap="nowrap"><a href="adicionar.php?id=<?php=$funcionamentos[$i]->id?>"><img src="../images/mais.jpg" width="20" height="21" border="0" /></a></td>
                    </tr>
                   <?php 
							}
						?>
			...
			?>
			 <div align="center"><span class="verdanaAzul">
			 	Não existem situações defuncionamento cadastrados
              ...
              <table cellpadding="0" cellspacing="0" width="96%" class="tabela1">
                ...
                <tr>
				  ...
				  <table cellpadding="1" cellspacing="1" width="100%">
                      <tr>
                        <td width="41%" class="tabela1_titulo2">Situação de Funcionamento</td>
                        <td width="51%" class="tabela1_titulo2">Impedimento</td>
                      ...
                      <tr>
                        ...
                        <td class="tabela1_linha2" nowrap="nowrap">
                          <select name="impedimento" class="FORMULARIO">
						  	<option <?php  if($impedimento == 0){?> selected="selected" <?php  }?> value="0">Não</option>
							<option <?php  if($impedimento == 0){?> selected="selected" <?php  }?> value="1">Sim</option>
					    </select></td>
