          ...
          <table width="180" border="0" cellpadding="0" cellspacing="0" >
            <tr>
              ...
              <td width="120" bgcolor="#DEE2E2" class="verdanaAzul">
                <div align="left">
                  <input name="login" type="text" class="FORMULARIO" id="login" value="<?php  if(isset($_POST["login"])) echo(stripslashes($_POST["login"]));?>"  size="16">
                  </div></td>
            </tr>
            <tr height="25">
              ...
              <td bgcolor="#DEE2E2" class="verdanaAzul">
                <div align="left">
                  <input name="senha" type="password" class="FORMULARIO" size="16">
                  </div></td>
            </tr>			
			<tr>
              <td colspan="2" align="right" height="50" valign="middle" ><div align="center"><input type="image" src="images/temp/logar.jpg" width="62" height="26"></div></td>
              </tr>
          </table>         
        </div></td>
		</tr>
