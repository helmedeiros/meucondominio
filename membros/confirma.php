                ...
                <td valign="top" bgcolor="#6492af"><br>
                   <form action="reserva.php" method="post">
				    <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td colspan="3"><p class="style3">Voc&ecirc; solicitou a  reserva da Quadra Poli-esportiva para o dia 
						  ...
						  <p class="style3"><input type="hidden" name="id_objeto" id="id_objeto" value="1">
