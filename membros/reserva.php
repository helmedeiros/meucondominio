            ...
            <tr>
                <td valign="top" bgcolor="#6492af"><br>
				    <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="100%"><p class="style3">A Quadra foi reservada com sucesso  no dia 
						  ...
						  <p align="center" class="style3"><a href="quadra.php?data=<?php=$reserva->data_inicio?>" class="style3">Voltar</a></p></td>
                      </tr>
                    </table>
                  <br>
                <br></td>
